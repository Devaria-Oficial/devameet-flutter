...
class PeerConnectionServiceImpl implements PeerConnectionService{
  StreamProxy? local;
  ...
  Future<rtc.RTCPeerConnection> createPeerConnection(String clientId) async {
    final peerConnection = await rtc.createPeerConnection({"iceServers": [{ "urls": 'stun:stun.l.google.com:19302'}],});
